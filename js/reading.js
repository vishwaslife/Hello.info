...
const fullPostContent = {
  1: {
    ...
    content: `
      <h2>🧼 BASICS OF SKIN & DAILY CARE</h2>
      ...
      <p>Har person ki skin alag hoti hai—oily, dry, normal, combination ya sensitive. Galat skin type ke product use karne se acne, dryness ya irritation hoti hai. Pehle apni skin type samajhna zaroori hai, tabhi skincare effective hoti hai.</p>
      
      <h3>3. Daily Skincare for Beginners</h3>
      <p>Beginners ke liye skincare complicated nahi honi chahiye. Sirf 3 cheez kaafi hoti hain—face wash, moisturizer aur sunscreen. Ye skin ko clean, hydrated aur protected rakhta hai. Simple routine follow karna long-term me best results deta hai.</p>
      
      <h3>4. Morning vs Night Skincare Theory</h3>
      <p>Morning routine ka goal protection hota hai—cleaning aur sunscreen. Night routine ka kaam repair hota hai—moisturizer aur treatment products. Din bhar skin damage hoti hai aur raat me repair hoti hai, isliye dono routines ka role alag hota hai.</p>
      ...
      <h2>🧴 PRODUCTS & THEIR USES</h2>
      
      <h3>11. Face Wash: How & When</h3>
      <p>Face wash din me do baar use karna chahiye—subah aur raat. Ye dirt, oil aur pollution remove karta hai. Over-washing se skin dry ho sakti hai. Mild face wash skin ko clean karta hai bina damage kiye.</p>
